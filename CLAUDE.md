...
- `docs/ROADMAP.md`：技术栈、Phase 0–5 实施顺序、任务主追踪表（R-###）、依赖关系、指标×信息面矩阵、§6 待确认/风险项、§7 架构决策记录（ADR D1–D7）。
...
PRD §4 Decision Log 与 ROADMAP §7 ADR 共享 D 编号：**ROADMAP §7 为权威详记**，PRD §4 仅作速查摘要。任何决策变更先改 ROADMAP §7，再同步 PRD §4。
